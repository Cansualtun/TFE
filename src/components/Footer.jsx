    ...
    <div className="absolute left-0">
        <div className="mb-10 ml-20">
            <a href="/src/index.html" className="mt-40">
             <img src="/src/image/logos.svg" className="mr-5 h-25 mt-15" alt="TradeForEveryone"></img>
...
<span className="text-sm text-gray-500  dark:text-gray-400" style="margin-left:600px">© 2022 <a href="https://flowbite.com" className="hover:underline">TradeForEveryone™</a>. All Rights Reserved.
</span>
